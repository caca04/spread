...
public class Master implements BasicMessageListener
{
	...
	public Master(String Server, String address, int port,int prioridade)
	{
		name = Server;
		//Sets the priority
		priority = prioridade;
		...
		rt = new ListenerMaster(connection,hash,name,priority);
		rt.start();
	...
	{			
		...
		Master u = new Master(Server, address, port,priority);
	}
